...
import { activateIntervention, deactivateIntervention, sendAgentMessage, getInterventionLog, } from './intervention.service.js';
export async function interventionRoutes(app) {
    // POST /conversations/:id/intervention/activate
    app.post('/conversations/:id/intervention/activate', { preHandler: authenticate }, async (request, reply) => {
    ...
    app.post('/conversations/:id/intervention/deactivate', { preHandler: authenticate }, async (request, reply) => {
        const businessId = request.businessId;
        const { id: conversationId } = request.params;
        try {
    ...
    app.post('/conversations/:id/intervention/message', { preHandler: authenticate }, async (request, reply) => {
        const businessId = request.businessId;
        const { id: conversationId } = request.params;
        const body = request.body;
    ...
    app.get('/conversations/:id/intervention/log', { preHandler: authenticate }, async (request, reply) => {
        const businessId = request.businessId;
        const { id: conversationId } = request.params;
        try {
...
//# sourceMappingURL=intervention.routes.js.map