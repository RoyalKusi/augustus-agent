...
import { createProduct, getProduct, updateProduct, deleteProduct, searchProducts, createCombo, listCombos, updateCombo, deleteCombo, getActiveComboCarouselItems, importProductsFromCsv, getProductRevenue, } from './catalogue.service.js';
import { uploadFile } from '../../storage/upload.js';
import { randomUUID } from 'crypto';
export async function catalogueRoutes(app) {
    // ── Products ──────────────────────────────────────────────────────────────
